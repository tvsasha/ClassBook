...
namespace ClassBook.Migrations
{
    ...
    [Migration("20260615121152_AddAcademicPeriodsAndFinalGrades")]
    partial class AddAcademicPeriodsAndFinalGrades
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassBook.Domain.Entities.AcademicPeriod", b =>
                {
                    ...
                    b.HasIndex("AcademicYearId", "Type", "Sequence")
                        .IsUnique();

                    b.ToTable("AcademicPeriods");
                });

            modelBuilder.Entity("ClassBook.Domain.Entities.AcademicYear", b =>
                {
                    b.Property<int>("AcademicYearId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassBook.Domain.Entities.ClassTeacher", b =>
                {
            ...
            modelBuilder.Entity("ClassBook.Domain.Entities.FinalGrade", b =>
                {
                    ...
                    b.HasIndex("AcademicPeriodId", "StudentId", "SubjectId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ClassBook.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("QrLoginIssuedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("QrLoginTokenHash")
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("QrLoginTokenHash")
                        .IsUnique()
                        .HasFilter("[QrLoginTokenHash] IS NOT NULL");
            ...
            modelBuilder.Entity("ClassBook.Domain.Entities.AcademicPeriod", b =>
                {
                    b.HasOne("ClassBook.Domain.Entities.AcademicYear", "AcademicYear")
                        .WithMany("Periods")
            ...
            modelBuilder.Entity("ClassBook.Domain.Entities.ClassTeacher", b =>
                {
                    ...
                    b.HasOne("ClassBook.Domain.Entities.User", "Teacher")
                        .WithMany("ClassTeacherAssignments")
            ...
            modelBuilder.Entity("ClassBook.Domain.Entities.FinalGrade", b =>
                {
                    b.HasOne("ClassBook.Domain.Entities.AcademicPeriod", "AcademicPeriod")
                        .WithMany("FinalGrades")
                        .HasForeignKey("AcademicPeriodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClassBook.Domain.Entities.User", "SetByUser")
                        .WithMany("FinalGradesSet")
            ...
            modelBuilder.Entity("ClassBook.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("ClassTeacherAssignments");

                    b.Navigation("FinalGradesSet");
